...
public class Field {
   ...
   private static ArrayList<BoardPos[][]> history = new ArrayList<BoardPos[][]>();
   ...
   public static void printPotentialTurns(boolean turn) {
      ...
      for (int i = 0; i < potenTurns.size(); i++) {
         matrix[potenTurns.get(i)[1]][potenTurns.get(i)[0]].SetToStringVal("?");
      }
      printField(matrix);
   }
   ...
   public static BoardPos[][] copyField() {
   ...
   public boolean addStone(Boolean team, int x, int y) {
   ...
   public static void keepScore(int a, int b) {
   ...
   public static void uniqueAdd(ArrayList<int[]> turns, int[] arr) {
      boolean flag = true;
      for (int i = 0; i < turns.size(); i++) {
         if (turns.get(i)[0] == arr[0] && turns.get(i)[1] == arr[1]) {
            flag = false;
         }
      }
      if (flag) {
   ...
   private static ArrayList<int[]> checkIfCloses(ArrayList<int[]> turns, boolean turn) {
      ArrayList<int[]> correctTurns = new ArrayList<int[]>();
   ...
   public static int evaluateStone(int y, int x) {
      if (x == 0 || y == 0 || x == 7 || y == 7)
         return 2;
      return 1;
   }
